...
echo "Note: Dependencies are organized in groups:"
echo "  - main: CLI dependencies (typer, pyyaml, paramiko)"
echo "  - node-manager: Server dependencies (fastapi, sqlmodel, kubernetes, etc.)"
echo "  - dev: Development dependencies (pytest, pytest-asyncio)"