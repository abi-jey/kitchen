...
### Comments
Code comments, commit messages and so on should be useable for explaining behavior, not unnecessary context. like "Generated by Copilot" and other similar comments are not useful, must be avoided.
