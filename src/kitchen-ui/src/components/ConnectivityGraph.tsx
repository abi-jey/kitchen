      ...
      edges.select('.edge-path')
        .attr('d', (d) => {
          ...
          if (effectiveVertical) {
            ...
            // Use fixed curve offset for consistent appearance
            const ctrlOffset = Math.min(Math.abs(endY - startY) * 0.5, 100);
            ctrl1X = startX;
            ...
            // Use fixed curve offset for consistent appearance
            const ctrlOffset = Math.min(Math.abs(endX - startX) * 0.5, 100);
